...
import lombok.Data;
import project.exception.code.BaseResponseCode;
import project.exception.code.ResponseCodeInterface;
...
public class DataResult {
    ...
    public static DataResult success(String message) {
        return new DataResult(BaseResponseCode.SUCCESS.getCode(), message);
    }
